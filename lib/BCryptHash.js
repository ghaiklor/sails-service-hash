...
/**
 * Get salt for bcrypt arguments
 * @returns {String|Number}
 * @private
 */
BCryptHash.prototype._getBCryptSalt = function () {
  return this.getSalt() || this.getSaltLength();
};
 ...
 * @returns {Promise}
 */
BCryptHash.prototype.hash = function (data, salt) {
  return new Promise(function (resolve, reject) {
    bcrypt.hash(data, salt || this._getBCryptSalt(), function (error, hash) {
 ...
 */
BCryptHash.prototype.hashSync = function (data, salt) {
  return bcrypt.hashSync(data, salt || this._getBCryptSalt());
};
 ...
 * @returns {Promise}
 */
BCryptHash.prototype.compare = function (data, hash) {
  return new Promise(function (resolve, reject) {
    bcrypt.compare(data, hash, function (error, equal) {
 ...
 */
BCryptHash.prototype.compareSync = function (data, hash) {
